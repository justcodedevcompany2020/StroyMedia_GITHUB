...
function ScrollableAccordionItem(props) {
  ...
  const {
    children, onPress, arrowComponent, wrapperStyle, headerStyle, arrowStyle, childrenStyle, item, expanded, activeTab,
  } = props;
  ...
  return (<View style={[styles.wrapper, wrapperStyle]}>
    ...
    >
      ...
      >
        {arrowComponent ? (arrowComponent) : openLastMessage ? (<ImageArrowUp/>) : (<ImageArrowDown/>)}
      </TouchableOpacity>
    </TouchableOpacity>
...
const styles = StyleSheet.create({
  wrapper: {
  ...
  }, header: {}, headerBorder: {}, arrowView: {
    position: "absolute", right: 2, top: 10, paddingVertical: 30, paddingHorizontal: 30,
  }, children: {}, expandedText: {
    color: COLOR_9, fontSize: 9, fontFamily: "GothamProRegular", lineHeight: 11, marginVertical: 10, marginLeft: 10,
  }, item: {
    backgroundColor: COLOR_5,
    paddingVertical: 20,
    ...
    flexDirection: "row", alignItems: "center", marginBottom: 6, justifyContent: "space-between",
  }, photo: {
    width: 50, height: 50, borderRadius: 50, marginRight: 10,
  }, block: {
    flex: 1,
  }, personName: {
    fontSize: 10, fontFamily: "GothamProRegular", color: COLOR_1, marginRight: 6,
  }, companyName: {
    fontSize: 10, fontFamily: "GothamProRegular", color: COLOR_9,
  }, time: {
    fontSize: 10, fontFamily: "GothamProRegular", color: COLOR_9,
  }, chatName: {
    fontSize: 10, fontFamily: "GothamProMedium", color: COLOR_1, marginBottom: 6, width: "90%",
  }, lastMessage: {
    fontSize: 9, fontFamily: "GothamProRegular", color: COLOR_9,
  }, messageAuthor: {
    fontSize: 10, fontFamily: "GothamProMedium", color: COLOR_9,
  }, nameRow: {
    flexDirection: "row",
  },
});
