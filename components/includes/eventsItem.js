          ...
          dispatch(checkChatExistRequest({token: token, id: id}))
            ...
            .then(() => {
              navigation.navigate("Chat", {
                currentPage: "Чаты", title: title, id: id,
              });
            });
        }}
      >
...
const styles = StyleSheet.create({
  section: {
    ...
    fontFamily: "GothamProRegular", fontSize: 12, color: COLOR_1, marginBottom: 10, marginTop: 20,
  }, sectionText: {
    fontFamily: "GothamProRegular", fontSize: 9, color: COLOR_9, marginBottom: 15, lineHeight: 11, textAlign: "left",
  }, personBlock: {
    marginBottom: 34,
  }, personName: {
    fontFamily: "GothamProRegular", fontSize: 10, color: COLOR_1,
  }, personPosition: {
